...
> Uno de los pocos motores de blog sencillos que funciona con **~82 MB RSS** en reposo (con 4 workers; mantiene **68-120 MB** en un servidor de producción real con un solo worker) y **~117 MB** bajo C10k (10 000 conexiones simultáneas).  
