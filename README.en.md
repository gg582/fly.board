...
> One of the few simple blog engines running at **~577 MB RSS** at idle (with 4 workers; maintains **90-200 MB** with a single worker), and **~658 MB** under C10k (10,000 concurrent connections).  
