...
> One of the few simple blog engines that keeps memory nearly flat as connections scale: **~108 MB RSS** at idle even with a single worker (**~102 MB** with 4 workers), and still **~110–146 MB** under C10k, C100k, and even C1m.
