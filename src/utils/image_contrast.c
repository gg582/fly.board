                         ...
                         char *logo_filter_out, size_t logo_filter_len)
{
    ...
    if (ok != 0) {
        snprintf(bg_style_out, bg_style_len,
                 "background-image:url('%s');background-size:cover;background-position:center;border-radius:12px;margin-bottom:0",
                 image_url);
    ...
    if (use_white && min_cw < target_contrast) {
        ...
        snprintf(bg_style_out, bg_style_len,
                 "background-image:linear-gradient(rgba(0,0,0,%.2f),rgba(0,0,0,%.2f)),url('%s');"
                 "background-size:cover;background-position:center;border-radius:12px;margin-bottom:0",
                 overlay_alpha, overlay_alpha, image_url);
        ...
        snprintf(bg_style_out, bg_style_len,
                 "background-image:url('%s');background-size:cover;background-position:center;padding:40px 20px 20px;border-radius:12px;margin-bottom:0",
                 image_url);
