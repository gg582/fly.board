...
cwist_sstring *render_post_editor(cJSON *boards, cJSON *post, cJSON *files, bool dark, const char *user_role, const char *error, const char *profile_pic, bool is_mobile) {
    ...
    cwist_sstring_append(b, "<div class='preview-edit-hint' style='font-size:12px;color:var(--muted);padding:12px 16px 0;border-bottom:1px dashed var(--border);margin-bottom:-1px'>Click preview to edit</div>");
