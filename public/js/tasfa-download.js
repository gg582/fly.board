    ...
    function upgradeMediaElement(el) {
        ...
        if (tagName === 'img') {
            ...
            if (el.getAttribute('data-tasfa-animated-gif') === '1') {
                el.style.opacity = '1';
                el.setAttribute('data-tasfa-ready', '1');
                // GIF preview responses are already image/gif and loop forever.
                // Do not start a second TASFA transfer alongside the img request:
                // concurrent duplicate downloads could exhaust post-load sessions.
                return;
            }
