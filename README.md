...
> One of the few simple blog engines running at **~82 MB RSS** at idle (with 4 workers; maintains **90-200 MB** with a single worker), and **~117 MB** under C10k (10,000 concurrent connections).  
